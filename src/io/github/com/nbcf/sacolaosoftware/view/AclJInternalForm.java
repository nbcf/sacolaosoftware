 ...
 * @author nil_b
 */
public class AclJInternalForm extends javax.swing.JInternalFrame {

    /**
     * Creates new form AclJInternalForm
     */
private static AclJInternalForm  aclJInternalForm;
    public static AclJInternalForm getUEAclJInternalForm(){
       if(aclJInternalForm == null){
            aclJInternalForm = new AclJInternalForm();
            }
            return aclJInternalForm;
       }
    

    
          public AclJInternalForm() {
        initComponents();
