 ...
 * @author nil_b
 */
public class EstoqueJInternalForm extends javax.swing.JInternalFrame {

    /**
     * Creates new form EstoqueJInternalForm
     */
//    public EstoqueJInternalForm() {
//        initComponents();
//    }
    private static EstoqueJInternalForm  estoqueJInternalForm;
    public static EstoqueJInternalForm getUEEstoqueJInternalForm(){
       if(estoqueJInternalForm == null){
            estoqueJInternalForm = new EstoqueJInternalForm();
            }
            return estoqueJInternalForm;
       }
