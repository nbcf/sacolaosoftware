 ...
 * @author nil_b
 */
public class FornecedorJInternalForm extends javax.swing.JInternalFrame {

    /**
     * Creates new form FornecedorJInternalForm
     */
//    public FornecedorJInternalForm() {
//        initComponents();
//    }
    private static FornecedorJInternalForm  fornecedorJInternalForm;
    public static FornecedorJInternalForm getUEFornecedorJInternalForm(){
       if(fornecedorJInternalForm == null){
            fornecedorJInternalForm = new FornecedorJInternalForm();
            }
            return fornecedorJInternalForm;
       }
