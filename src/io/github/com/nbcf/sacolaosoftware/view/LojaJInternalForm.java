 ...
 * @author nil_b
 */
public class LojaJInternalForm extends javax.swing.JInternalFrame {

    /**
     * Creates new form LojaJInternalForm
     */
//    public LojaJInternalForm() {
//        initComponents();
//    }
    private static LojaJInternalForm  lojaJInternalForm;
    public static LojaJInternalForm getUELojaJInternalForm(){
       if(lojaJInternalForm == null){
            lojaJInternalForm = new LojaJInternalForm();
            }
            return lojaJInternalForm;
       }
